    ...
    <main className="bg-light-background text-primary-dark">
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <form className="mt-8 grid gap-4">
          ...
          <input className="rounded-xl border border-primary-green bg-light-background px-4 py-3" placeholder="Address" />
          <input className="rounded-xl border border-primary-green bg-light-background px-4 py-3" placeholder="City" />
          <input className="rounded-xl border border-primary-green bg-light-background px-4 py-3" placeholder="State" />
          <input className="rounded-xl border border-primary-green bg-light-background px-4 py-3" placeholder="ZIP Code" />
